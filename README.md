...
| 홈                       | 댓글 작성                 |
|-------------------------|-----------------------|
| ![img.png](img/홈.png) | ![img.png](Img/댓글작성.png) |
...
### 문정호
- 연관관계 매핑과 깃 사용법 등 아직 이해와 사용을 못하고 있는 개념들이 많다는 것을 깨닫는 시간이 되었습니다.
- API 명세서 작업을 좀 더 구체화하는 것이 작업 속도 향상과 완성도를 높이는 데 중요하다는 것을 느끼게 되었습니다.
- 제 파트만 보는 것이 아닌 다른 사람의 파트들을 살펴보면서 프로그램이 어떤 식으로 돌아가는지 파악을 빨리 하는 것이, 결국 제가 담당한 파트의 생산성을 높인다는 것을 알 수 있었습니다.

### 유진원
- 팀프로젝트를 진행하면서, 협업에서 지켜야할 내용을 생각해볼수 있게 되었습니다.
- 팀 프로젝트를 진행하면서, 코드를 작성하기 전에 규칙을 정해두는 것이 협업에 큰 도움이 된다는 걸 깨달았습니다.
...
### 황다현
- 처음진행한 팀 프로젝트로써, 팀원들과 어떠한 소통을 해야하는지, Git을 어떻게 써야하는지 알게된 계기가 되었습니다.
- 여태껏 배운 내용을 활용해보는 좋은 경험이 되었습니다.
- JPQL과 JWT가 어떤식으로 사용되는지 활용할수 있는 계기가 되었습니다.
- 다른 분들의 코드를 이해해보기도하고, 협업 과정에서 여러 사람들이 잘 이해하기 쉬운 코드란 어떠한 방법으로 작성해야할지 생각해보는 계기가 되었습니다.
